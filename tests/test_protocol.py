...
def test_all_method_names_are_strings():
    ...
    methods = [
        "AddNode", "RemoveNode", "HasNode", "GetNodes", "NodeCount", "NodeIds",
        "AddEdge", "RemoveEdge", "HasEdge", "GetEdges", "EdgeCount",
        "TopologicalSort", "FindCycle", "GetShortestPath", "PageRank",
        "ConnectedComponents", "CommunityDetection", "GraphColoring",
        "CreateGraph", "DeleteGraph", "ListGraphs",
        "CreateChannel", "JoinChannel", "LeaveChannel", "CloseChannel",
        "SendMessage", "GetChannelMessages", "ListChannels", "GetChannelMembers",
        "Ping", "Shutdown", "Checkpoint", "Reconcile",
    ]
    for m in methods:
