...
#[cfg(feature = "sql")]
pub use sql::{
    classify, default_spill_rows, exec_sql, exec_sql_arrow, exec_sql_arrow_cancellable,
    exec_sql_cached, exec_sql_over_tables, exec_sql_typed, exec_sql_typed_cancellable,
    exec_sql_typed_with_tables, exec_sql_typed_with_tables_cached_cancellable,
    exec_sql_typed_with_tables_cancellable, infer_param_sites, parse_create_ann_index,
    plan_ann_search, plan_bm25_search, returning_columns, schema_probe_sql, AlterTableAction,
    ...
    CreateViewPlan, DeleteNodes, DeleteNodesJoin, DeleteTable, DropFunctionPlan, DropTablePlan,
