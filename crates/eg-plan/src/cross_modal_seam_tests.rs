//! Cross-modal SEAM regression proofs (CONCEPT:EG-359).
//!
...
// ─────────────────────────────────────────────────────────────────────────────
// Reason → Traverse → Rank  (CONCEPT:EG-359, semantic-source mid-pipeline)
// ─────────────────────────────────────────────────────────────────────────────
...
/// Plan-SHAPE proof (CONCEPT:EG-359): the cost reorder still picks the winning
...
// ─────────────────────────────────────────────────────────────────────────────
// SensorFuse → Rank  (CONCEPT:EG-359, timeseries-source mid-pipeline)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// TensorScan → Rank  (CONCEPT:EG-359, tensor-source mid-pipeline)
// ─────────────────────────────────────────────────────────────────────────────
