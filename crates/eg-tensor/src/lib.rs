...
// lives in eg-tsdb (kept pure-Rust / Pi-lean). Reached from a wire plan through
// eg-plan's `Op::SensorAlign` executor arm. Folded into node/full with the tensor tier,
// kept OUT of `pi`.
pub mod fusion;
mod store;
mod tensor;
