//! # eg-kvcache — tiered + shared KV-cache store (CONCEPT:EG-185 / CONCEPT:EG-186)
//!
...
//!
//! * **[`TieredCache`] (CONCEPT:EG-185)** — a three-tier (HOT raw-RAM / WARM
...
//!
//! * **[`SharedKvBackend`] + [`SharedKvIndex`] (CONCEPT:EG-186)** — a content-addressed,
...
mod integration_tests {
    ...
    /// CONCEPT:EG-185 + EG-186 — the end-to-end story: a shared backend dedups KV pages
