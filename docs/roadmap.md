...
| **Memory → weights distillation** | 🗺 | Distilling consolidated agent-memory (EG-KG.compute.hierarchical-summary-tier-eg/221) into model weights (a fine-tune/LoRA export), beyond the retrieval-time context assembly (EG-195). |
